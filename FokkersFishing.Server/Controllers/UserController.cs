...
namespace FokkersFishing.Server
{
    ...
    public class UserController : Controller
    {
        ...
        public UserInfo GetUser()
        {
            ...
            {
                UserInfo userInfo = new UserInfo() { Name = User.Identity.Name, IsAuthenticated = true, IdentityProvider = User.Identity.AuthenticationType.ToString(), Id = User.FindFirst(ClaimTypes.NameIdentifier).Value };
                return userInfo;
            }
            else
            {
